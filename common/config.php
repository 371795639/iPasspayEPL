...
class SysConfig{
	...
	//支付请求网关访问地址
	const PAY_URL = 'http://14.23.90.101:180/paycenter/v2.0/getoi.do';//http://14.23.90.100/paycenter/v2.0/getoi.do
	//订单请求类网关访问地址
	const ORDER_URL = 'https://14.23.90.100:443/paycenter/gateways.do';//'http://14.23.90.100/paycenter/gateways.do';
	//本地字符编码
