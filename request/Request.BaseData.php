...
class RequestBaseData{
	...
	function __construct() {
		$this->values["partner"] = SysConfig::PARTNER;
		$this->values["sign_type"] = SysConfig::SIGN_TYPE;
		$this->values["version"] = SysConfig::VERSION;
		$certs = array();
		openssl_pkcs12_read(file_get_contents(SysConfig::PFX_PATH), $certs, SysConfig::PRIVATEKEY_PASSWORD); //其中password为你的证书密码
		if(!$certs) return '';
